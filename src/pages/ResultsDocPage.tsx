...
const ResultsDocPage: React.FC = () => {
    return (
        <div className="w-full min-h-screen p-6 space-y-6 bg-white">
            <div className="rounded-2xl shadow-md border border-muted overflow-hidden">
                ...
                <div className="p-6 space-y-6">
                    ...
                    <Section title="3. Ответы на вопросы">
                        ...
                        <p><strong>О:</strong> Возможно, задача завершилась с ошибкой. Попробуйте загрузить еще раз.
                        </p>
                    </Section>
                </div>
            </div>
